...
def load_data(database_filepath):
    ...
    # Given value 2 in the related field are negligible so it could be error. Replacing 2 with 1 to consider it a valid
    # response. Alternatively, we could have assumed it to be 0 also. In the absence of information I have gone with
    # majority class.
...
def tokenize(text, url_place_holder_string="urlplaceholder"):
    ...
    # Lemmanitizer to remove inflectional and derivations related forms of a word
...
def main():
    ...
    # If we need we can use other machine learning algorithms such as "starting_verb_transformer"

    # print('Building the pipeline with starting_verb_transformer ...')
    # pipeline2 = build_pipeline2()
    #
    # print('Training the pipeline2 ...')
    # pipeline2.fit(X_train, Y_train)
    #
    # print('Evaluating model...')
    # evaluate_pipeline(pipeline2, X_test, Y_test, category_names)
    #
    # print('Saving pipeline2 to {} ...'.format(pickle_filepath))
    # save_model(pipeline2, pickle_filepath)
    #
    # print('Trained model saved!')
